...
```json
{
  ...
  "year": 2025,
  "location": "台北市中正區",
  "summary": "這是一個範例建案，用來測試建案新增與展示功能。",
  ...
  "body": "這裡是建案內文範例，描述建案特色與亮點。"
}

{
  "title": "關於我們",
  "intro": "本公司美感空間，建設城市願景",
...
建案類別固定：透天／華廈／電梯大樓／其他

建案 Facts 使用「完工日」而非工期

聯絡表單：電話必填、Email 選填、建案項目必填
