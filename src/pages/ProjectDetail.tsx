    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">找不到建案</h2>
          <p className="text-gray-600 mb-6">此建案不存在或已被移除</p>
          <Link
            to="/projects"
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-end">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
            <nav className="text-white text-sm mb-4">
              ...
              <Link to="/projects" className="hover:underline">建案列表</Link>
              <span className="mx-2">/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="text-2xl font-bold text-gray-900 mb-6">建案介紹</h2>
          ...
          <div className="lg:col-span-1">
            ...
            >
              <h3 className="text-xl font-semibold text-gray-900 mb-6">建案資訊</h3>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                <p className="text-sm text-gray-600 mb-4">建案摘要</p>
